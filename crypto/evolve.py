...
def run_evolution(
    ...
    btc_candles = repo.get_latest("BTCUSDT", limit=50000)  # ~35 days of 1-min data
    ...
    if use_portfolio:
        ...
        for sym in portfolio_symbols:
            ...
            sym_candles = repo.get_latest(sym, limit=50000)  # ~35 days of 1-min data
        ...
        symbol_candles = repo.get_latest(symbol, limit=50000)  # ~35 days of 1-min data
